...
import 'package:stream_transform/stream_transform.dart' as stream;
...
class ApplicationLayoutModelController extends JuneState {
                              ...
                              (info) => Container(
                                ...
                                child: JuneBuilder(
                                  ...
                                  builder: (controller) {
                                    ...
                                    layout.appConfiguration = layout
                                        .appConfiguration
                                        .copyWith(
                                          selectedTabbedPanel:
                                              ApplicationPanel.models,
                                        );
                                    return ListView.builder(
                            ...
                            return Form(
                              ...
                              child: TextFormField(
                                decoration: const InputDecoration(
                                  hintText: 'mcp server endpoint',
                                  helperText: 'ex. http://example.org/mcp',
                                ),
                                validator: (String? value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Enter url for mcp server e.g. https://www.example.org/mcp/list';
                                  }
                                  final uri = Uri.tryParse(value) ?? Uri();
                                  if (uri.scheme != 'http' &&
                                      uri.scheme != 'https') {
                                    return 'Invalid url scheme for MCP Server endpoint';
                                  }
                                  return null;
                                },
                                onFieldSubmitted: (value) {
                                  ...
                                  unawaited(
                                    toolsController.insert(
                                      Uri.tryParse(value) ?? Uri(),
                                    ),
                                  );
                                  formKey.currentState?.reset();
                                  toolsController.setState();
                                },
                              ),
                            );
                          },
                              ...
                              (info) => Container(
                                ...
                                child: JuneBuilder(
                                  ...
                                  builder: (toolsController) {
                                    final tools = toolsController.tools.entries;
                                    final messagingController = June.getState(
                                      StreamingMessageController.new,
                                    );
                                    final sessionId =
                                        messagingController.sessionId;
                                    final actives =
                                        (toolsController.actives[sessionId] ??
                                                <ActiveTool>[])
                                            .map(
                                              (e) =>
                                                  Uri.tryParse(
                                    ...
                                    return tools.isNotEmpty
                                        ? ListView.builder(
                                          ...
                                          itemBuilder: (
                                            ...
                                            final toolMap = tools.elementAt(
                                              index,
                                            );
                                            final toolList = toolMap.value;
                                            return ExpansionTile(
                                              title: Column(
                                                children: [
                                                  Text(
                                                    toolMap.key.toString(),
                                                    style:
                                                        theme
                                                            .textTheme
                                                            .bodyMedium,
  ...
  void _showAboutDialog(BuildContext context) {
    ...
    showAboutDialog(
      context: context,
      applicationName: 'AI4All Premium Edition',
