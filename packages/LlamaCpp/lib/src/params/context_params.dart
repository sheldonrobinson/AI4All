...
class ContextParams with ChangeNotifier {
  ...
  factory ContextParams.fromMap(Map<String, dynamic> map) {
    return ContextParams(
      nCtx: map['_nCtx']?.toInt() ?? 0,
      nBatch: map['_nBatch']?.toInt(),
      nUBatch: map['_nUBatch']?.toInt(),
      nSeqMax: map['_nSeqMax']?.toInt(),
      nThreads: map['_nThreads']?.toInt(),
      nThreadsBatch: map['_nThreadsBatch']?.toInt(),
      ropeScalingType: map['_ropeScalingType'] != null ? RopeScalingType.fromString(map['_ropeScalingType']) : null,
      poolingType: map['_poolingType'] != null ? PoolingType.fromString(map['_poolingType']) : null,
      attentionType: map['_attentionType'] != null ? AttentionType.fromString(map['_attentionType']) : null,
      ropeFrequencyBase: map['_ropeFrequencyBase']?.toDouble(),
      ropeFrequencyScale: map['_ropeFrequencyScale']?.toDouble(),
      yarnExtrapolationFactor: map['_yarnExtrapolationFactor']?.toDouble(),
      yarnAttenuationFactor: map['_yarnAttenuationFactor']?.toDouble(),
      yarnBetaFast: map['_yarnBetaFast']?.toDouble(),
      yarnBetaSlow: map['_yarnBetaSlow']?.toDouble(),
      yarnOriginalContext: map['_yarnOriginalContext']?.toInt(),
      defragmentationThreshold: map['_defragmentationThreshold']?.toDouble(),
      typeK: map['_typeK'] != null ? GgmlType.fromString(map['_typeK']) : null,
      typeV: map['_typeV'] != null ? GgmlType.fromString(map['_typeV']) : null,
      embeddings: map['_embeddings'],
      offloadKqv: map['_offloadKqv'],
      flashAttention: map['_flashAttention'],
      noPerformance: map['_noPerformance'],
    );
  }
  ...
  factory ContextParams.fromJson(String source) => ContextParams.fromMap(json.decode(source));
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'_nCtx': _nCtx});
    if(_nBatch != null){
      result.addAll({'_nBatch': _nBatch});
    }
    if(_nUBatch != null){
      result.addAll({'_nUBatch': _nUBatch});
    }
    if(_nSeqMax != null){
      result.addAll({'_nSeqMax': _nSeqMax});
    }
    if(_nThreads != null){
      result.addAll({'_nThreads': _nThreads});
    }
    if(_nThreadsBatch != null){
      result.addAll({'_nThreadsBatch': _nThreadsBatch});
    }
    if(_ropeScalingType != null){
      result.addAll({'_ropeScalingType': _ropeScalingType!.name});
    }
    if(_poolingType != null){
      result.addAll({'_poolingType': _poolingType!.name});
    }
    if(_attentionType != null){
      result.addAll({'_attentionType': _attentionType!.name});
    }
    if(_ropeFrequencyBase != null){
      result.addAll({'_ropeFrequencyBase': _ropeFrequencyBase});
    }
    if(_ropeFrequencyScale != null){
      result.addAll({'_ropeFrequencyScale': _ropeFrequencyScale});
    }
    if(_yarnExtrapolationFactor != null){
      result.addAll({'_yarnExtrapolationFactor': _yarnExtrapolationFactor});
    }
    if(_yarnAttenuationFactor != null){
      result.addAll({'_yarnAttenuationFactor': _yarnAttenuationFactor});
    }
    if(_yarnBetaFast != null){
      result.addAll({'_yarnBetaFast': _yarnBetaFast});
    }
    if(_yarnBetaSlow != null){
      result.addAll({'_yarnBetaSlow': _yarnBetaSlow});
    }
    if(_yarnOriginalContext != null){
      result.addAll({'_yarnOriginalContext': _yarnOriginalContext});
    }
    if(_defragmentationThreshold != null){
      result.addAll({'_defragmentationThreshold': _defragmentationThreshold});
    }
    if(_typeK != null){
      result.addAll({'_typeK': _typeK!.name});
    }
    if(_typeV != null){
      result.addAll({'_typeV': _typeV!.name});
    }
    if(_embeddings != null){
      result.addAll({'_embeddings': _embeddings});
    }
    if(_offloadKqv != null){
      result.addAll({'_offloadKqv': _offloadKqv});
    }
    if(_flashAttention != null){
      result.addAll({'_flashAttention': _flashAttention});
    }
    if(_noPerformance != null){
      result.addAll({'_noPerformance': _noPerformance});
    }
