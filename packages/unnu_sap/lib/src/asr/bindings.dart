...
@ffi.DefaultAsset('package:unnu_sap/src/asr/bindings.dart')
library;
...
@ffi.Native<
    ffi.Void Function(SherpaOnnxOnlineRecognizerConfig,
        SherpaOnnxVadModelConfig, SherpaOnnxOnlinePunctuationConfig)>()
external void unnu_asr_init(
  SherpaOnnxOnlineRecognizerConfig config,
  SherpaOnnxVadModelConfig vadConfig,
  SherpaOnnxOnlinePunctuationConfig punctConfig,
);

@ffi.Native<ffi.Void Function(SoundEventCallback)>()
external void unnu_asr_set_sound_callback(
  SoundEventCallback sound_callback,
);

@ffi.Native<ffi.Void Function()>()
external void unnu_asr_unset_sound_callback();

@ffi.Native<ffi.Void Function(TranscriptCallback)>()
external void unnu_asr_set_transcript_callback(
  TranscriptCallback transcript_callback,
);

@ffi.Native<ffi.Void Function()>()
external void unnu_asr_unset_transcript_callback();

@ffi.Native<ffi.Void Function(VoiceActivityDetectedCallback)>()
external void unnu_asr_set_listening_callback(
  VoiceActivityDetectedCallback listening_callback,
);

@ffi.Native<ffi.Void Function()>()
external void unnu_asr_unset_listening_callback();

@ffi.Native<ffi.Void Function(ffi.Pointer<UnnuASRBoolStruct_t>)>()
external void unnu_asr_free_bool(
  ffi.Pointer<UnnuASRBoolStruct_t> ptr,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<UnnuASRTextStruct_t>)>()
external void unnu_asr_free_transcript(
  ffi.Pointer<UnnuASRTextStruct_t> ptr,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<UnnuASRFloatStruct_t>)>()
external void unnu_asr_free_float(
  ffi.Pointer<UnnuASRFloatStruct_t> ptr,
);

@ffi.Native<ffi.Void Function(ffi.Bool)>()
external void unnu_asr_enable(
  bool enable,
);

@ffi.Native<ffi.Bool Function()>()
external bool unnu_asr_is_enabled();

@ffi.Native<ffi.Void Function(ffi.Bool)>()
external void unnu_asr_mute(
  bool mute,
);

@ffi.Native<ffi.Bool Function()>()
external bool unnu_asr_is_muted();

@ffi.Native<ffi.Void Function(ffi.Bool)>()
external void unnu_asr_punctuate(
  bool punctuate,
);

@ffi.Native<ffi.Bool Function()>()
external bool unnu_asr_is_punctuated();

@ffi.Native<ffi.Void Function(ffi.Int32)>()
external void unnu_asr_nudge(
  int ms,
);

/// FFI_PLUGIN_EXPORT bool unnu_asr_stop();
@ffi.Native<ffi.Bool Function()>()
external bool unnu_asr_is_streaming();

@ffi.Native<ffi.Bool Function()>()
external bool unnu_asr_is_supported();

@ffi.Native<ffi.Void Function()>()
external void unnu_asr_destroy();
...
enum UnnuTranscriptType {
  ...
  final int value;
  const UnnuTranscriptType(this.value);

  static UnnuTranscriptType fromValue(int value) => switch (value) {
        0 => START,
        1 => CHUNK,
        2 => PARTIAL,
        3 => FINAL,
        4 => END,
        _ =>
          throw ArgumentError('Unknown value for UnnuTranscriptType: $value'),
      };
}

final class UnnuASRBoolStruct extends ffi.Struct {
  @ffi.Bool()
  external bool value;
}

typedef UnnuASRBoolStruct_t = UnnuASRBoolStruct;

final class UnnuASRTextStruct extends ffi.Struct {
  external ffi.Pointer<ffi.Char> text;
...
typedef UnnuASRTextStruct_t = UnnuASRTextStruct;

final class UnnuASRFloatStruct extends ffi.Struct {
  @ffi.Float()
  external double value;
}

typedef UnnuASRFloatStruct_t = UnnuASRFloatStruct;
typedef TranscriptCallbackFunction = ffi.Void Function(
    ffi.Int type, ffi.Pointer<UnnuASRTextStruct_t> transcript);
typedef DartTranscriptCallbackFunction = void Function(
    int type, ffi.Pointer<UnnuASRTextStruct_t> transcript);
typedef TranscriptCallback
    = ffi.Pointer<ffi.NativeFunction<TranscriptCallbackFunction>>;
typedef SoundEventCallbackFunction = ffi.Void Function(
    ffi.Pointer<UnnuASRFloatStruct_t>);
typedef DartSoundEventCallbackFunction = void Function(
    ffi.Pointer<UnnuASRFloatStruct_t>);
typedef SoundEventCallback
    = ffi.Pointer<ffi.NativeFunction<SoundEventCallbackFunction>>;
typedef VoiceActivityDetectedCallbackFunction = ffi.Void Function(
    ffi.Pointer<UnnuASRBoolStruct_t>);
typedef DartVoiceActivityDetectedCallbackFunction = void Function(
    ffi.Pointer<UnnuASRBoolStruct_t>);
typedef VoiceActivityDetectedCallback
    = ffi.Pointer<ffi.NativeFunction<VoiceActivityDetectedCallbackFunction>>;
