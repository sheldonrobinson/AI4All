...
static std::atomic<severity_level> log_verbosity = []() {
    if (const char* env_var = std::getenv("UNNU_DXL_LOG_VERBOSITY")) {
...
std::unique_ptr<log_record_stream> create_log_record_stream(severity_level severity, source_location location)
{
