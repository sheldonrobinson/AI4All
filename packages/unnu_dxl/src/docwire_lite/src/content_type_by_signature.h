 ...
 */
class DOCWIRE_CORE_EXPORT database : public with_pimpl<database>
{
public:
    explicit database();
    friend DOCWIRE_CORE_EXPORT void detect(data_source& data, const database& database_to_use, allow_multiple allow_multiple);
};
...
* @see content_type::by_signature::detector
*/
DOCWIRE_CORE_EXPORT void detect(data_source& data, const database& database_to_use = database{}, allow_multiple allow_multiple = {false});
